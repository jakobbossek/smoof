...
class(makeWFG7Function) = c("function", "smoof_generator")
attr(makeWFG7Function, "name") = c("WFG7")
attr(makeWFG7Function, "type") = c("multi-objective")
attr(makeWFG7Function, "tags") = c("multi-objective")
