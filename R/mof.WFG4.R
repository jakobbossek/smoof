...
#'  Returns an instance of the WFG4 function as a \code{smoof_multi_objective_function} object.
#' @details 
...
#' 
#' @export
makeWFG4Function = function(n.objectives, k, l) {
  ...
  fn = function(x) {
    ...
    mof_WFG_4(z = x, M = n.objectives, k = k)
  }

  makeMultiObjectiveFunction(
    name = "WFG4 function",
    id = sprintf("WFG4-%id-%io", dimensions, n.objectives),
    description = "WFG4 function",
    fn = fn,
...
class(makeWFG4Function) = c("function", "smoof_generator")
attr(makeWFG4Function, "name") = c("WFG4")
attr(makeWFG4Function, "type") = c("multi-objective")
attr(makeWFG4Function, "tags") = c("multi-objective")
