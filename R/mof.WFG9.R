...
#'  Returns an instance of the WFG9 function as a \code{smoof_multi_objective_function} object.
#' @details 
...
#' 
#' @export
makeWFG9Function = function(n.objectives, k, l) {
  ...
  fn = function(x) {
    ...
    mof_WFG_9(z = x, M = n.objectives, k = k)
  }

  makeMultiObjectiveFunction(
    name = "WFG9 function",
    id = sprintf("WFG9-%id-%io", dimensions, n.objectives),
    description = "WFG9 function",
    fn = fn,
...
class(makeWFG9Function) = c("function", "smoof_generator")
attr(makeWFG9Function, "name") = c("WFG9")
attr(makeWFG9Function, "type") = c("multi-objective")
attr(makeWFG9Function, "tags") = c("multi-objective")
