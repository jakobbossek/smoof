...
makeWFG2Function = function(n.objectives, k, l) {
  ...
  fn = function(x) {
    ...
    return(mof_WFG_2(z = x, M = n.objectives, k = k))
  }
...
class(makeWFG2Function) = c("function", "smoof_generator")
attr(makeWFG2Function, "name") = c("WFG2")
attr(makeWFG2Function, "type") = c("multi-objective")
attr(makeWFG2Function, "tags") = c("multi-objective")
