...
#' @export
makeHartmann6Function = function() {
  makeSingleObjectiveFunction(
    name = "Hartmann6 Function",
    id = "hartmann_6d",
    fn = function(x) {
    ...
    tags = attr(makeHartmann6Function, "tags"),
    global.opt.params = c(0.20169, 0.150011, 0.476874, 0.275332, 0.311652, 0.6573),
    global.opt.value = -3.32237
  )
}

class(makeHartmann6Function) = c("function", "smoof_generator")
attr(makeHartmann6Function, "name") = c("Hartmann6")
attr(makeHartmann6Function, "type") = c("single-objective")
attr(makeHartmann6Function, "tags") = c("single-objective", "continuous")
