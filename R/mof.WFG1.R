...
#'  Returns an instance of the WGF1 function as a \code{smoof_multi_objective_function} object.
#' @details 
...
#' 
#' @export
makeWFG1Function = function(n.objectives, k, l) {
  ...
  fn = function(x) {
    ...
    mof_WFG_1(z = x, M = n.objectives, k = k)
  }

  makeMultiObjectiveFunction(
    name = "WFG1 function",
    id = sprintf("WFG1-%id-%io", dimensions, n.objectives),
    description = "WFG1 function",
    fn = fn,
...
class(makeWFG1Function) = c("function", "smoof_generator")
attr(makeWFG1Function, "name") = c("WFG1")
attr(makeWFG1Function, "type") = c("multi-objective")
attr(makeWFG1Function, "tags") = c("multi-objective")
